...
export function startSeasonalCycle(initialProgress) {
  ...
  function tick() {
    ...
    if (groundMat) {
       ...
       * (0x3a2a20) is blended in at 10% weight at the start of spring,
      ...
      if (seasonIndex === 0 && seasonProgress < 0.30) {
        ...
        const winterGround = new THREE.Color(0x3a2a20);
