 ...
 * and logical operators (and, or, not) and C-style logical operators (&&, ||, !).
...
function registerBoolean(interpreter) {
  ...
  // C-style logical operators (same semantics as word operators)
...
export function checkProperties(run) {
  ...
  // Idempotence and complement for symbols
  ...
  try {
    ...
    if (!(e instanceof TypeError)) {
      failures.push('true && 1 should throw TypeError, got ' + e);
    }
  }
  try {
    run('0 && true');
    failures.push('0 && true should throw TypeError');
  } catch (e) {
    if (!(e instanceof TypeError)) {
      failures.push('0 && true should throw TypeError, got ' + e);
    }
  }
  try {
    run('\"true\" && false');
    ...
    if (!(e instanceof TypeError)) {
      failures.push('\"true\" && false should throw TypeError, got ' + e);
    }
  }
  ...
  try {
    ...
    if (!(e instanceof TypeError)) {
      failures.push('\"false\" || true should throw TypeError, got ' + e);
    }
  }
  ...
  try {
    ...
    if (!(e instanceof TypeError)) {
      failures.push('!1 should throw TypeError, got ' + e);
    }
  }
  try {
    run('!\"true\"');
    ...
    if (!(e instanceof TypeError)) {
      failures.push('!\"true\" should throw TypeError, got ' + e);
    }
  }
  ...
  // Precedence: and higher than or (word operators)
