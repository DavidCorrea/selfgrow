...
const PHASES = [
  ...
  },
  {
    name: 'Overcast',
    t: 1 / 3,
    skyTint: new THREE.Color(0.50, 0.50, 0.55),
    sunIntensityMul: 0.35,
    sunColorMul: new THREE.Color(0.75, 0.75, 0.80),
    ambientIntensityMul: 1.8,
    ambientColorMul: new THREE.Color(0.80, 0.80, 0.90),
    hemiIntensityMul: 0.7,
    hemiColorMul: new THREE.Color(0.60, 0.60, 0.70),
    hemiGroundMul: new THREE.Color(0.70, 0.70, 0.75),
    fillIntensityMul: 0.85,
    fillColorMul: new THREE.Color(0.80, 0.80, 0.90),
  ...
  },
  {
    name: 'Light Drizzle',
    t: 2 / 3,
    skyTint: new THREE.Color(0.35, 0.45, 0.65),
    sunIntensityMul: 0.20,
    sunColorMul: new THREE.Color(0.60, 0.70, 0.85),
    ambientIntensityMul: 1.5,
    ambientColorMul: new THREE.Color(0.55, 0.70, 0.90),
    hemiIntensityMul: 0.55,
    hemiColorMul: new THREE.Color(0.45, 0.60, 0.85),
    hemiGroundMul: new THREE.Color(0.55, 0.60, 0.70),
    fillIntensityMul: 0.80,
    fillColorMul: new THREE.Color(0.55, 0.75, 0.90),
