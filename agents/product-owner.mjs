...
function buildProductOwnerPrompt() {
  return [
    ...
    "",
    "## Types of Refinements That Are Valuable",
    "",
    "- Add a new item to the roadmap (step 7, 8, etc.) that naturally follows from what's built",
    ...
    "- Address a user-reported issue — if an open bug or feature request is relevant, the refinement can respond to it (e.g. add a clarifying principle, adjust the roadmap, acknowledge the concern)",
    "",
    "## Types of Refinements to Avoid",
    "",
    "- Rewriting existing sections (too noisy)",
    "- Adding features to the roadmap that are unrelated to the garden metaphor",
